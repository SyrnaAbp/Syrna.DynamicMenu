...
namespace Syrna.DynamicMenu.MainDemo.Permissions;

public class MainDemoPermissionDefinitionProvider : PermissionDefinitionProvider
{
    public override void Define(IPermissionDefinitionContext context)
    {
        var accountingPreGroup = context.AddGroup(MainDemoPermissions.GroupName);
        //Define your own permissions here. Example:
        //myGroup.AddPermission(DemoPermissions.MyPermission1, L("Permission:MyPermission1"));

        accountingPreGroup.AddPermission("MainDemo", L("Permission:MainDemo"));
